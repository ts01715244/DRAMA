...
function videoZVV(name) { 
  str = '<iframe frameborder="0" height="760" marginheight="0" marginwidth="0" scrolling="no" src="https://googledrive.com/host/0B8QlaU9AmBqDfmM3Sm1UZnZvVUNnb1piTmZJUDVkWHRnTVBweHFDZk94M1owdWdQckQ5Unc/'+name+'.html" width="100%" allowfullscreen></iframe>';
  return str;
}
...
function videoG(id,name) {
  document.getElementById("player1").innerHTML = videoGG(id,name);		
}
